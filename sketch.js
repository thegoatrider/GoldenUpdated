...
//2nd state code
  ...
  fill(255,153,0);
  textSize(35);
  text('Please stand 30 metres away',120,200);
  ...
  if(gameState === 4){
    ...
    fill(255,153,0);
    textSize(35);
    text('Please stand 20 metres away',170,200);
    ...
    fill(255,153,0);
    textSize(35);
    text('Please stand 15 metres away',170,200);
  ...
  if(gameState === 6){
    ...
    fill(255,153,0);
    textSize(35);
    text('Please stand 12 metres away',170,200);
  ...
  if(gameState === 7){
    ...
    fill(0,0,0);
    textSize(25);
    text('Congratulations! You have completed the test.',150,180);
